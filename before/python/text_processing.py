...
def normalize(input_string):
    ...
    * 앞뒤 필요없는 띄어쓰기는 제거해야함
    ...
    normalized_list = input_string.lower()
    normalized_list = normalized_list.split()
...
def no_vowels(input_string):
    ...
    """
    no_vowel_string = ""
    vowel_strings = ['A','a','E','e','I','i','O','o','U','u']

    for i in input_string:
        if i not in vowel_strings:
            no_vowel_string += i
...
input_string2 = "We love Python!"
result = no_vowels(input_string2)
print(result)